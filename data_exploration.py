...
if __name__ == "__main__":
    ...
    img_paths = glob.glob(path_to_images + "/*.jpg")
    label_paths = glob.glob(path_to_labels + "/*.txt")
    ...
    with open(label_path, "r") as label_file:
        ...
        for line in lines:
            ...
            x_center, y_center, box_width, box_height = float(x_center), float(y_center), float(box_width), float(
                box_height)
